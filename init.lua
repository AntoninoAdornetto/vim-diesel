...
-- Remap for moving selected line(s) up/down
...
-- Test execution (vim-test) keymaps
...
vim.keymap.set('n', '<leader>fb', require('telescope.builtin').buffers, { desc = '[S]earch by [B]buffer' })
